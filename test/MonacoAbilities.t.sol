...
contract MonacoAbilitiesTest is Test {
    ...
    function test_storageOverwrite(uint32 balance, uint32 speed, uint32 shield, uint32 y) public {
        monaco.setCarData(
            mockCar1, Monaco.CarData({balance: balance, car: mockCar1, speed: speed, shield: shield, y: y})
        );

        (uint32 balance_, uint32 speed_, uint32 y_, uint32 shield_, ICar car_) = monaco.getCarData(mockCar1);
    ...
    function testAction_shield() public {
        ...
        monaco.setCarData(
            mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: car2Speed, shield: 0, y: car2Start})
        );
        ...
        monaco.setCarData(
            mockCar1, Monaco.CarData({balance: 15000, car: mockCar1, speed: car1Speed, shield: 0, y: car1Start})
        );
    ...
    function testAction_banana() public {
        ...
        monaco.setCarData(
            mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 200, shield: 0, y: carPosition})
        );
    ...
    function testAction_shell_banana() public {
        ...
        monaco.setCarData(
            mockCar1, Monaco.CarData({balance: 15000, car: mockCar1, speed: 100, shield: 0, y: car1Position})
        );

        uint32 car2Position = 50;
        monaco.setCarData(
            mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 100, shield: 0, y: car2Position})
        );
        mockCar2.setAction(Monaco.ActionType.SHELL, 1);
